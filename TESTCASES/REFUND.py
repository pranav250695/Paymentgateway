...
row = Xlutils.GetRowCount(TESTCLASS.DATA_PATH,"Sheet4")

for r in range(2,row+1):
    MER_TXN_NO= Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,1)
    AMOUNT=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,2)
    PASSCODE=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,3)
    TERMINAL_ID=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,4)
    MERCHANT_ID=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,5)
    TXN_TYPE=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,6)
    REF_TXN_NO=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,7)
    REFUND_AMOUNT=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,8)
    CAPTURE_AMOUNT=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,9)
    CURRENCY=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,10)
    CANCELLATION_ID=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,11)
    REFUND_REASON_CODE=Xlutils.ReadData(TESTCLASS.DATA_PATH,"Sheet4",r,12)
    ...
    if message == 'Success':
        ...
        Xlutils.WriteData(TESTCLASS.DATA_PATH,"Sheet4",r,13,"test pass")
        driver.get('https://sandbox.isgpay.com/KotakPGRedirect/merchant/rac/racAPI.jsp')
        logger.info("refund Success")
    else:
        print('refund failed')
        Xlutils.WriteData(TESTCLASS.DATA_PATH, "Sheet4", r, 13, "test fail")
        driver.get('https://sandbox.isgpay.com/KotakPGRedirect/merchant/rac/racAPI.jsp')
